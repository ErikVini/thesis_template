  ...
  \section{Características deste template}
    ...
    \subsection{Exemplos}
      ...
      \subsubsection{Tabelas}
        ...
        Você também pode criar células que abrangem várias colunas ou linhas usando o comando \ttt{\textbackslash multirow\{número de linhas\}\{tamanho (ou * para automático)\}\{Texto\}}:
        %
        \begin{table}[h]
          \centering
          \caption{Exemplo de tabela.}
