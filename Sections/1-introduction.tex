  ...
  \section{Características deste template}
    ...
    \subsection{Exemplos}
      ...
      \subsection{Fazendo plots no \ttt{Matplotlib}}
        ...
        As outras opções e mais detalhes deste código estão descritas no link acima. Dois exemplos de imagens geradas com essa função estão nas Figuras \ref{fig:matplot_1} e \ref{fig:matplot_2}. Note que nenhum caractere dentro da imagem tem tamanho menor do que os da legenda (que é um bom teste para saber se o tamanho das letras e números está bom) e como a imagem ocupa toda a largura do texto mesmo sem ser necessário usar a opção [width=\textbackslash linewidth].
        %
        \begin{figure}[h]
          \centering
        ...
        \begin{figure}[h]
          ...
          \caption{Outro xemplo de figura feita usando a função \ttt{set\_size}.}
          \label{fig:matplot_2}
        \end{figure}
