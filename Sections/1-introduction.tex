...
\chapter{\chapternameintro}
  ...
  \section{Características deste template}
    ...
    \subsection{WebLaTex}
      ...
      Da forma que ele está configurado neste template, o \LaTeX{}
    ...
    \subsection{VSCode e suas extensões}
      ...
      Na presente versão, o template habilita, além das extensões do WebLaTex, a extensão ``GitDoc''. Esta extensão faz commit+push automaticamente toda vez que você salva o arquivo ou em intervalos definidos pelo usuário.
