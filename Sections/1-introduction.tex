  ...
  \section{Características deste template}
    ...
    \subsection{Exemplos}
      ...
      \subsection{Fazendo plots no \ttt{Matplotlib}}
        ...
        Note que nenhum caractere dentro da imagem tem tamanho menor do que os da legenda (que é um bom teste para saber se o tamanho das letras e números está bom) e como a imagem ocupa toda a largura do texto mesmo sem ser necessário usar a opção [width=\textbackslash linewidth].
