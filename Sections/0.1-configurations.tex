...
% Layout and Geometry
\usepackage[a4paper, left=2cm, right=2cm, top=3cm, bottom=2cm, bindingoffset=1cm]{geometry}  % Page margins
...
{\thesection\hspace{24.5pt}\textcolor{gray75}{|}\hspace{14pt}}{0pt}{\LARGE\bfseries}
[]

\titleformat{\subsection}[hang]{\Large\bfseries}  % Subsection format
{{\thesubsection}\hsp\textcolor{gray75}{|}\hsp}{0pt}{\Large\bfseries}
[]
