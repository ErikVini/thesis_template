...
\usepackage[english]{babel}  % Language support, here set to English
...
\usepackage[font={small,it}]{caption}  % Caption formatting, small and italic
...
% Layout and Geometry
\usepackage[a4paper, left=3cm, right=2cm, top=3cm, bottom=3cm]{geometry}  % Page margins
...
% To print code
%\usepackage{pythonhighlight}    % Use with \begin{python} ... \end{python}
